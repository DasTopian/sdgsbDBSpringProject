...
public class CarPartTest {
	...
	public void insertTest() {
		...
		CarPartsInventory cpi = (CarPartsInventory)context.getBean("carPartsImp1");
		
		CarPart carpart=new CarPart();
		carpart.setPartNo(2);
		carpart.setPartName("PlasticElastic");
		carpart.setCarModel("Doraemon");
		carpart.setQuantity(69);
